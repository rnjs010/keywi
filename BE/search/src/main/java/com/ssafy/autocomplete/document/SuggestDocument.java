...
public class SuggestDocument {
    ...
    // 자동완성에 사용될 텍스트
    @Field(name = "name", type = FieldType.Text, analyzer = "suggest_index_analyzer", searchAnalyzer = "suggest_search_analyzer")
    private String name;

    // 해당 키워드에 대한 추가 설명 (선택 사항)
    @Field(name = "content", type = FieldType.Text, analyzer = "suggest_index_analyzer", searchAnalyzer = "suggest_search_analyzer")
    ...
    // 검색된 횟수 (인기 자동완성 정렬용)
    @Field(name = "searchCount", type = FieldType.Integer)
